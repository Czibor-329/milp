...
class RecomputeFailureOutputTests(unittest.TestCase):
    ...
    def test_frontend_version_and_cache_keys_are_1_4_19(self) -> None:
        ...
        self.assertEqual("1.4.19", package["version"])
        self.assertEqual("1.4.19", package_lock["version"])
        self.assertEqual("1.4.19", package_lock["packages"][""]["version"])
        self.assertIn('class="frontend-version">前端 v1.4.19</span>', template)
        self.assertIn('/assets/config_editor.css?v=1.4.19', template)
        self.assertIn('/assets/config_editor.js?v=1.4.19', template)
...
class ConfigEditorServerTests(unittest.TestCase):
    ...
    def test_editor_uses_persistent_route_table_and_step_drawer(self) -> None:
        ...
        self.assertIn('class="frontend-version">前端 v1.4.19</span>', html)
